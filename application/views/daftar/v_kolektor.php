	...
	<section id="scol1" class="main">
		<div class="tb_container">
			<div class="search_container">
					...
					<input type="text" class="search_field" placeholder="Kode/Nama Kolektor" onfocus="this.placeholder=''" 
					onblur="this.placeholder='Kode/Nama Kolektor'" />
...
<?php load_js("script", "nav", "dialog", "global", "daftar/kolektor"); ?>
</html>
